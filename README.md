...
- [Query Performance Tuning & Query Rewriting (Arabic - عربي) with Amr Elhelw](https://www.youtube.com/watch?v=RtXQug0DuVo&t=11s)
- [SQL Stored Procedures (Arabic - عربي) with Amr Elhelw](https://www.youtube.com/watch?v=4nBPnPg-als)
- [Database Sharding (Arabic - عربي) with Amr Elhelw](https://www.youtube.com/watch?v=-GXQwCIRANA)
- [Distributed Databases (Arabic - عربي) with Amr Elhelw](https://www.youtube.com/watch?v=LujY8mdibGk)
- [Data Partitioning (Arabic - عربي) with Amr Elhelw](https://www.youtube.com/watch?v=XnCnIWMxEhA)
- [Concurrency Control: Multi Version Concurrency Control (Arabic - عربي) with Amr Elhelw](https://www.youtube.com/watch?v=RDry1RyIw1s)
- [Concurrency Control: Timestamp Ordering & Optimistic CC (Arabic - عربي) with Amr Elhelw](https://www.youtube.com/watch?v=f6sl5XFnAr4)
- [Concurrency Control: Two-Phase Locking - Part 1 (Arabic - عربي) with Amr Elhelw](https://www.youtube.com/watch?v=s8w-GplT6K4)
- [Concurrency Control: Two-Phase Locking - Part 2 (Arabic - عربي) with Amr Elhelw](https://www.youtube.com/watch?v=4Ll7zlC9f4w)
- [Transactions (1) - ACID Properties (Arabic - عربي) with Amr Elhelw](https://www.youtube.com/watch?v=ziH5Y4tvQJE)
- [Query Execution (Arabic - عربي) with Amr Elhelw](https://www.youtube.com/watch?v=Hl0SwV1RFFs)
- [SQL Join Types - Inner, Outer, Semi-join, Anti-join (Arabic - عربي) with Amr Elhelw](https://www.youtube.com/watch?v=4RmzfVUVxYI)
- [SQL Query Optimizer (Arabic - عربي) with Amr Elhelw](https://www.youtube.com/watch?v=iAxFGRbAh8s)
- [SQL Query Life Cycle (Arabic - عربي) with Amr Elhelw](https://www.youtube.com/watch?v=SEKF4u6Ovyw)
- [Database Indexes - Index Intersection, Union & more (Arabic - عربي) with Amr Elhelw](https://www.youtube.com/watch?v=KTEViriyc-Q&list=PLE8kQVoC67PzGwMMsSk3C8MvfAqcYjusF&index=8)
